                    ...
                    <div key={idx} className="bg-black/30 border border-white/5 rounded-lg p-5 hover:border-purple-500/30 transition-colors relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="mt-4 pt-4 border-t border-white/5 flex gap-2">
                                <button className="flex-1 bg-white/5 hover:bg-purple-500/20 text-xs text-slate-300 hover:text-white py-2 rounded border border-white/5 hover:border-purple-500/30 transition-all flex items-center justify-center gap-2">
